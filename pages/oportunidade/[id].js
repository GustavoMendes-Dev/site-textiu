                            ...
                            <div class="blog-post">
                                ...
                                <div class="mt-1 mb-3">
                                    ...
                                    <ul class="list-inline d-inline-block">
                                        <li class="list-inline-item">{oportunidade[0].salary_range}</li>
                                    </ul>
                              
                                    <h5 class="d-inline-block mr-3">Contratação</h5>
                                    <ul class="list-inline d-inline-block">
                                        <li class="list-inline-item">{oportunidade[0].hiring}</li>
                                    </ul>
                                
                                    <h5 class="d-inline-block mr-3">Categoria</h5>
                                    <ul class="list-inline d-inline-block">
                                        <li class="list-inline-item">{oportunidade[0].categories}</li>
                                    </ul>

                                    <h5 class="d-inline-block mr-3">Vagas</h5>
                                    <ul class="list-inline d-inline-block">
                                        <li class="list-inline-item">{oportunidade[0].vacancies}</li>
                                    </ul>
                                </div>
                                
                                <h5 class="d-inline-block mr-3">Descrição:</h5>
                                <p class="mt-3">{oportunidade[0].description}</p>
